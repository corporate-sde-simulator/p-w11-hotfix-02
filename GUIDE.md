...
> **Welcome to Product-Track Week 11, Hotfix 2!**
...
1. **Read the comments** at the top of `slow_endpoint.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `slow_endpoint.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "1: It fetches ALL records then filters in Python instead"
...
### Bug #2
**User Report / Alert:**
> "2: It recalculates the full summary on every request"
...
### Bug #3
**User Report / Alert:**
> "Fetches ALL rows, then filters in Python"
...
1. **Read the top comment block** in `slow_endpoint.py` carefully - it has:
